...
public class PentaGun extends Weapon{

	short xSpeed;
	public PentaGun(Sprite sprite, short rateOfFire, short speedOfProjectile,Texture tex,short xSpeed) {
	...
	public void shoot(byte dirY) {
		...
		projectiles.add(Projectile.create(s.x, s.y, dirY,(short)0,tex,LEFT,xSpeed));
		projectiles.add(Projectile.create(s.x, s.y, dirY,(short)0,tex,RIGHT,xSpeed));
